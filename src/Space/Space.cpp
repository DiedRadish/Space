...
Space::Info buildcb(std::multimap<std::string, std::string>)
{
	return Space::Info();
}

int main(int argc, char* argv[]) {
	Space::CommandLine cl("Space",true);
	auto u = cl.AddUnit({"build", "build the file"}, &buildcb);
	cl.AddArgv(u, {"-o", "out file"}, "", true, false, false);
